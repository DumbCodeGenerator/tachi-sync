 ...
 * @return {boolean}
 */
index.prototype.isCached = function (image, callback) {
    self = this;
    fs.exists(Core.getFilePath(image, self.options), function (exists) {
        callback(exists);
    });
};
index.prototype.isCachedSync = function (image) {
    self = this;
 ...
 * @return undefined
 */
index.prototype.getCache = function (image, callback) {
    self = this;
...
index.prototype.Get = function (image) {
    self = this;
...
index.prototype.getCacheSync = function (image) {
    self = this;
 ...
 * @description
 * setCache
 * @param images {array|string} [required]
 * @param {function} [callback]
 * @example
 * setCache(['http://foo.bar/foo.png'], function(error) { });
 * @return {boolean}
 */
index.prototype.setCache = function (images, callback) {
    self = this;
...
index.prototype.Set = function (images) {
    self = this;
...
index.prototype.fetchImages = function (images) {
    self = this;
 ...
 * @return Promise
 */
index.prototype.delCache = function (images) {
    self = this;
 ...
 * @return undefined
 */
index.prototype.flushCache = function (callback) {
    self = this;
    ...
    fs.readdir(self.options.dir, (error, files) => {
        ...
        if (files.length === 0 && callback) {
            ...
            async.map(targetFiles, fs.unlink, function (error, results) {
                if (!callback) return;
...
index.prototype.flushCacheSync = function () {
    self = this;
